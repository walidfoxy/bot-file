                        ...
                        if '0300' in dataS.hex()[0:4] :
                            ...
                            if '0500' in dataS.hex()[:4] and b'\x05\x15\x00\x00\x00\x10Z\xca\xf5&T;\x0cA\x01\x16\xe0\x05\xb2\xea\xe4\x0b' in dataC:
                                ...
                                if '1200' in dataS.hex()[0:4] and '6635' in dataS.hex()[0:900]:
                                    ...
                                    invite.send(bytes.fromhex("0000005a0a0608251000180012404646443538464234463736463634384332413545323145424346413341414538314234433942374439374d455f313634313133343430323634333432373332381a0e0a0a313732323334333238361001"))
                                #/4
